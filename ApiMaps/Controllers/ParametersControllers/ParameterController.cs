...
namespace ApiMaps.Controllers.ParametersControllers
{
    /// <summary>
    ...
    public class ParameterController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="dto">Datos necesarios para actualizar el parámetro.</param>
        /// <returns>El parámetro actualizado.</returns>
        [HttpPut("update")]
        public async Task<IActionResult> UpdateParameterAsync([FromBody] UpdateParameterDto dto)
        {
            var updatedParameter = await _parameterService.UpdateAsync(dto).FirstAsync();
